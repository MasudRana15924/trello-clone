...
const Incomplete = () => {
    return (
        <div className="w-96 bg-gray-100 card-section ">
                <div className="flex justify-between bg-gray-100 h-16 items-center pl-2 pr-2 ">
                    <div className='flex gap-2'>
                        <button className="progress-btn w-6 h-4 mt-1 bg-red-600"></button>
                        <p className="text-gray-900 font-semibold ">Incomeplete</p>
                    </div>
                    <div>
